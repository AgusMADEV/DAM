...
ventana = tk.Window(themename="superhero")  
...
tk.Label(ventana,text="Dale al botón para calcular todo").pack(padx=15,pady=4)
boton1 = tk.Button(ventana,text="¡Vamos allá!",command=calcula)
boton1.pack(padx=50,pady=4)

tk.Label(ventana,text="----- RESULTADOS -----").pack(padx=15,pady=4)
