...
"""
servidorftp = 'XXXXXXXXXXXXX'                           # Datos de conexión al SFTP
puertoftp = 22
usuarioftp = 'XXXXXXXX'
contrasenaftp = 'XXXXXXXX'

carpetalocal = "D:/agustin/backups/"+fechacompuesta                     # Carpeta de origen en mi ordenador
...
carpetacopias = "D:/agustin/backups/"
carpetas = os.listdir(carpetacopias)
for carpeta in carpetas:
    ...
    if abs(int(fechaepoch) - round(time.time())) > 60*5:
        shutil.rmtree("D:/agustin/backups/"+carpeta)