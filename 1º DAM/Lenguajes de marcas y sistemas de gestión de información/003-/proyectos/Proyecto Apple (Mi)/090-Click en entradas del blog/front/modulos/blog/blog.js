function cargaBlog(){
    ...
    .then(function(datos) {                                                                  // Y cuando reciba datos
        ...
        datos.forEach(function(dato){                                                        // para cada dato recibido
            let instancia = plantilla.content.cloneNode(true);                               // Clono la plantilla original creando una instancia                                                   
            instancia.querySelector("h4").textContent = dato.titulo                          // Introduzco un titulo personalizado
            instancia.querySelector("time").textContent = dato.fecha                         // Introduzco una fecha personalizada
            ...
            principal.appendChild(instancia)                                                 // Añadimos la instancia a la etiqueta principal
        })
    })
}
cargaBlog();