...
"""
        ...
        ORDER BY numero DESC
        LIMIT 20;
""", "idiomas.jpg","Idiomas visitantes"
 )
...
sesion.graficaTarta(
    ...
    GROUP BY valor
    ORDER BY numero DESC;
    """, "sistemasoperativos.jpg","SSOO visitantes"
)
sesion.graficaTarta(
    """
    SELECT
    ...
    GROUP BY valor
    ORDER BY numero DESC;
    """, "navegadores.jpg","Navegadores visitantes"
)
sesion.graficaTarta(
    """
...
sesion.graficaTarta(
    ...
    """, "pantallas.jpg","Pantallas visitantes"
)
